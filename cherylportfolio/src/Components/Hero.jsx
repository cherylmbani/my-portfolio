      ...
      <div className="container">
        <div className="hero-content">
          ...
          <div className="hero-text">
            ...
            <h1 className="hero-name">Cheryl Mbani</h1>
            <h2 className="hero-title">
              Software <span className="accent">Engineer</span>
            </h2>
            <p className="hero-description">
              I build exceptional digital experiences through clean code, 
              innovative solutions, and user-focused design. 
              Currently crafting the future one line at a time.
            </p>
            ...
            <div className="hero-social">
              ...
              <a href="mailto:mbanicheryl45@gmail.com" aria-label="Email">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
